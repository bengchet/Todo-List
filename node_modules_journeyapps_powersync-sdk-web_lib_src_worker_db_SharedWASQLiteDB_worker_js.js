...
/***/ "./node_modules/@journeyapps/powersync-sdk-web/lib/src/worker/db/SharedWASQLiteDB.worker.js":
/*!**************************************************************************************************!*\
  !*** ./node_modules/@journeyapps/powersync-sdk-web/lib/src/worker/db/SharedWASQLiteDB.worker.js ***!
  \**************************************************************************************************/
...
/* harmony import */ var _open_db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./open-db */ "./node_modules/@journeyapps/powersync-sdk-web/lib/src/worker/db/open-db.js");
...
const openDB = dbFileName => __awaiter(void 0, void 0, void 0, function* () {
  ...
  return navigator.locks.request(OPEN_DB_LOCK, () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!DBMap.has(dbFileName)) {
      ...
      const connection = yield (0,_open_db__WEBPACK_IMPORTED_MODULE_1__._openDB)(dbFileName);
    ...
    const wrappedConnection = Object.assign(Object.assign({}, db), {
...
_self.onconnect = function (event) {
  ...
  comlink__WEBPACK_IMPORTED_MODULE_3__.expose(openDB, port);
};
...
/******/ })()
;
//# sourceMappingURL=node_modules_journeyapps_powersync-sdk-web_lib_src_worker_db_SharedWASQLiteDB_worker_js.js.map